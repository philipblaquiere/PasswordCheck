...
namespace PasswordCheck
{
	public static class RankingsProvider
	{
		...
		public static RankingSet Default => new RankingSet(
			name: nameof(Default),
			rankings: new[]
			{
		...
		public static RankingSet CustomRankings1 => new RankingSet(
			name: nameof(CustomRankings1),
			rankings: new[]
			{
				new KeyValuePair<int, string>(0, "No Ranking"),
		...
		public static List<RankingSet> Rankings => new List<RankingSet>
		{
			Default,
			CustomRankings1
		};
